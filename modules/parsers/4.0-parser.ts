...
export default class HyperionParser extends BaseParser {
    ...
    public async parseAction(
        ...
        // action.header_extensions = trx_data.header_extensions; // Add this line to include header_extensions
    ...
    public async parseMessage(worker: MainDSWorker, messages: Message[]): Promise<void> {
        for (const message of messages) {
            ...
            if (res.block && res.block.length) {
                ...
                block.header_extensions = deserialize('header_extension[]', res.header_extensions, this.txEnc, this.txDec, worker.types); // Deserialize header_extensions
            ...
            try {
                ...
                if (result) {
                    ...
                    if (block) {
                        ...
                        evPayload["header_extensions"] = block.header_extensions; // Include header_extensions in the event payload
                    }
