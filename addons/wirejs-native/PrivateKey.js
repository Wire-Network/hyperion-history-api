...
var PrivateKey = /** @class */ (function () {
    ...
    PrivateKey.fromString = function (keyString, ec) {
        var privateKey = (0, wirejs_numeric_1.stringToPrivateKey)(keyString);
        if (!ec) {
            ec = (0, wirejs_key_conversions_1.constructElliptic)(privateKey.type);
        }
    ...
    PrivateKey.prototype.toLegacyString = function () {
        return (0, wirejs_numeric_1.privateKeyToLegacyString)(this.key);
    };
    /** Export private key as WIREIO-format private key */
    PrivateKey.prototype.toString = function () {
        return (0, wirejs_numeric_1.privateKeyToString)(this.key);
    };
    ...
    PrivateKey.prototype.getPublicKey = function () {
        ...
        return wirejs_key_conversions_1.PublicKey.fromElliptic(ellipticPrivateKey, this.getType(), this.ec);
    };
    ...
    PrivateKey.prototype.sign = function (data, shouldHash, encoding) {
        ...
        var constructSignature = function (options) {
            ...
            return wirejs_key_conversions_1.Signature.fromElliptic(ellipticSignature, _this.getType(), _this.ec);
        };
        if (this.key.type === wirejs_numeric_1.KeyType.k1) {
            do {
