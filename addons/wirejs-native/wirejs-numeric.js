...
var rip = require('./ripemd');
// copyright defined in wirejs/LICENSE.txt
var ripemd160 = rip.RIPEMD160.hash;
...
var signedDecimalToBinary = function (size, s) {
    var negative = s[0] === '-';
    var modifiedString = negative ? s.slice(1) : s;
    var result = (0, exports.decimalToBinary)(size, modifiedString);
    if (negative) {
...
var stringToKey = function (s, type, size, suffix) {
    ...
    var digest = new Uint8Array((0, exports.digestSuffixRipemd160)(result.data, suffix));
...
var keyToString = function (key, suffix, prefix) {
    var digest = new Uint8Array((0, exports.digestSuffixRipemd160)(key.data, suffix));
...
/** If a key is in the legacy format (`SYS` prefix), then convert it to the new format (`PUB_K1_`).
...
//# sourceMappingURL=wirejs-numeric.js.map