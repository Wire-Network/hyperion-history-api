...
Object.defineProperty(exports, "PrivateKey", { enumerable: true, get: function () { return wirejs_key_conversions_1.PrivateKey; } });
Object.defineProperty(exports, "PublicKey", { enumerable: true, get: function () { return wirejs_key_conversions_1.PublicKey; } });
Object.defineProperty(exports, "Signature", { enumerable: true, get: function () { return wirejs_key_conversions_1.Signature; } });
    ...
    function JsSignatureProvider(privateKeys) {
        ...
        try {
            for (var privateKeys_1 = __values(privateKeys), privateKeys_1_1 = privateKeys_1.next(); !privateKeys_1_1.done; privateKeys_1_1 = privateKeys_1.next()) {
                ...
                var priv = wirejs_key_conversions_1.PrivateKey.fromString(k);
            ...
            return __generator(this, function (_c) {
                ...
                try {
                    for (requiredKeys_1 = __values(requiredKeys), requiredKeys_1_1 = requiredKeys_1.next(); !requiredKeys_1_1.done; requiredKeys_1_1 = requiredKeys_1.next()) {
                        ...
                        publicKey = wirejs_key_conversions_1.PublicKey.fromString(key);
                        ellipticPrivateKey = this.keys.get((0, wirejs_numeric_1.convertLegacyPublicKey)(key));
                        privateKey = wirejs_key_conversions_1.PrivateKey.fromElliptic(ellipticPrivateKey, publicKey.getType());
...
//# sourceMappingURL=wirejs-jssig.js.map