...
const rpc = new eosjs_jsonrpc_1.JsonRpc('http://localhost:8888', { fetch: node_fetch_1.default });
const signatureProvider = new eosjs_jssig_1.JsSignatureProvider([privateKey]);
const api = new eosjs_api_1.Api({
    rpc,
    signatureProvider,
...
describe('Chain API Plugin Endpoints', () => {
    it('validates return type of abi_bin_to_json', async () => {
        const result = await rpc.abi_bin_to_json('returnvalue', 'sum', '0500000005000000');
        const abiBinToJsonResult = {
            args: 'any',
        };
        verifyType(result, abiBinToJsonResult);
    });
    it('validates return type of abi_json_to_bin', async () => {
        const result = await rpc.abi_json_to_bin('returnvalue', 'sum', [5, 5]);
        const abiJsonToBinResult = {
            binargs: 'string',
        };
        verifyType(result, abiJsonToBinResult);
    });
    it('validates return type of get_abi', async () => {
        const result = await rpc.get_abi('todo');
        const getAbiResult = {
            account_name: 'string',
            'abi?': {
                version: 'string',
                ...
                'kv_tables?': {
                    todo: {
                        // key is dynamic, using result from todo account
                        type: 'string',
                        primary_index: {
                            name: 'string',
                            type: 'string',
    ...
    it('validates return type of get_account', async () => {
        const result = await rpc.get_account('eosio');
    ...
    it('validates return type of get_accounts_by_authorizers', async () => {
        const result = await rpc.get_accounts_by_authorizers([
        ...
        const getAccountsByAuthorizersResult = {
            accounts: {
                account_name: 'string',
    ...
    it('validates return type of get_activated_protocol_features', async () => {
        const result = await rpc.get_activated_protocol_features({});
        const getActivatedProtocolFeaturesResult = {
    ...
    it('validates return type of get_block_header_state', async () => {
        ...
        const result = await rpc.get_block_header_state(info.head_block_id);
        const getBlockHeaderStateResult = {
            id: 'string',
            header: {
                timestamp: 'string',
                producer: 'string',
    ...
    it('validates return type of get_block_info', async () => {
        const info = await rpc.get_info();
        const result = await rpc.get_block_info(info.last_irreversible_block_num);
        const getBlockInfoResult = {
            timestamp: 'string',
            producer: 'string',
            confirmed: 'number',
            previous: 'string',
    ...
    it('validates return type of get_block', async () => {
        const info = await rpc.get_info();
        const result = await rpc.get_block(info.last_irreversible_block_num);
    ...
    it('validates return type of get_code', async () => {
        const result = await rpc.get_code('todo');
        const getCodeResult = {
            account_name: 'string',
            code_hash: 'string',
            wast: 'string',
    ...
    it('validates return type of get_code_hash', async () => {
        const result = await rpc.get_code_hash('todo');
        const getCodeHashResult = {
            account_name: 'string',
            code_hash: 'string',
        };
    ...
    it('validates return type of get_currency_balance', async () => {
        const result = await rpc.get_currency_balance('eosio.token', 'bob', 'SYS');
        result.forEach((element) => {
            expect(typeof element).toEqual('string');
        });
    });
    it('validates return type of get_currency_stats', async () => {
        const result = await rpc.get_currency_stats('eosio.token', 'SYS');
        const getCurrencyStatsResult = {
            SYS: {
                supply: 'string',
                max_supply: 'string',
                issuer: 'string',
    ...
    it('validates return type of get_producer_schedule', async () => {
        const result = await rpc.get_producer_schedule();
        const getProducerScheduleResult = {
            'active&': {
                version: 'number',
                producers: {
                    producer_name: 'string',
    ...
    it('validates return type of get_producers', async () => {
        const result = await rpc.get_producers();
        const getProducersResult = {
            rows: {
                owner: 'string',
                'producer_authority?': [
                    'number|string',
    ...
    it('validates return type of get_raw_code_and_abi', async () => {
        const result = await rpc.get_raw_code_and_abi('eosio');
        const getRawCodeAndAbiResult = {
            account_name: 'string',
            wasm: 'string',
            abi: 'string',
        };
    ...
    it('validates return type of get_raw_abi', async () => {
        const result = await rpc.get_raw_abi('eosio');
        const getRawAbiResult = {
            account_name: 'string',
            code_hash: 'string',
            abi_hash: 'string',
            abi: 'string',
    ...
    it('validates return type of get_scheduled_transactions', async () => {
        const result = await rpc.get_scheduled_transactions();
        const getScheduledTransactionsResult = {
            transactions: {
                trx_id: 'string',
                sender: 'string',
                sender_id: 'string',
    ...
    it('validates return type of get_kv_table_rows', async () => {
        const result = await rpc.get_kv_table_rows({
            code: 'todo',
            table: 'todo',
    ...
    it('validates return type of get_required_keys', async () => {
        ...
        const result = await rpc.getRequiredKeys({
            transaction,
            availableKeys,
        });
        result.forEach((element) => {
    ...
    it('validates return type of push_transaction', async () => {
        ...
        const result = await rpc.push_transaction(transaction);
    ...
    it('validates return type of push_ro_transaction', async () => {
        ...
        const result = await rpc.push_ro_transaction(transaction);
        const readOnlyTransactResult = {
            head_block_num: 'number',
            head_block_id: 'string',
            last_irreversible_block_num: 'number',
            last_irreversible_block_id: 'string',
    ...
    it('validates return type of push_transactions', async () => {
        const transactionA = (await api.transact({
            actions: [
                {
                    account: 'eosio.token',
                    name: 'transfer',
        ...
        const transactionB = (await api.transact({
            actions: [
                {
                    account: 'eosio.token',
                    name: 'transfer',
        ...
        const result = await rpc.push_transactions([
            transactionA,
            transactionB,
        ]);
        const transactResult = {
    ...
    it('validates return type of send_transaction', async () => {
        ...
        const result = await rpc.send_transaction(transaction);
        const transactResult = {
            transaction_id: 'string',
            processed: {
                id: 'string',
...
describe('DB Size API Plugin Endpoints', () => {
    it('validates return type of get', async () => {
        const result = await rpc.db_size_get();
        const dbSizeGetResult = {
            free_bytes: 'number',
            used_bytes: 'number',
            size: 'number',
            indices: {
...
describe('Trace API Plugin Endpoints', () => {
    it('validates return type of get_block', async () => {
        const info = await rpc.get_info();
        const result = await rpc.trace_get_block(info.last_irreversible_block_num);
        const traceApiGetBlockResult = {
            id: 'string',
            number: 'number',
            previous_id: 'string',
            status: 'string',
...
const verifyType = (data, type) => {
    const verifiedKeys = Object.keys(type)
        .filter((key) => {
        ...
        if (Array.isArray(data[formattedKey])) {
            if (Array.isArray(type[key])) {
                data[formattedKey].forEach((element, index) => {
                    if (Array.isArray(element)) {
                        element.forEach((secondElement, secondIndex) => {
                ...
                data[formattedKey].forEach((element) => {
...
const complexOrPrimitive = (data, type, formattedKey) => {
